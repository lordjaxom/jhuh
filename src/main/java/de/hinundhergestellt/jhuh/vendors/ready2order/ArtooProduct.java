...
import static de.hinundhergestellt.jhuh.vendors.ready2order.ApiUtils.withDefault;
import static java.util.Objects.requireNonNull;

public class ArtooProduct {

    private ProductsGet200ResponseInner value;

    public ArtooProduct(String name, @Nullable String itemNumber, @Nullable String barcode, @Nullable String description,
...
//        value.setProductAlternativeNameInPos();
    ...
    ArtooProduct(ProductsGet200ResponseInner value) {
        this.value = value;
        fixUp();
    }
